...
# Chapter 9 - Homework(Simulation)  

### 1.  Compute the solutions for simulations with 3 jobs and random seeds of 1, 2, and 3.
```
PS C:\Users\huaxi\Desktop\cs5600-computer-system> python .\lottery.py -j 3 -s 1 -c
ARG jlist 
ARG jobs 3
ARG maxlen 10
ARG maxticket 100
...
```
```
PS C:\Users\huaxi\Desktop\cs5600-computer-system> python .\lottery.py -j 3 -s 2 -c
ARG jlist 
ARG jobs 3
ARG maxlen 10
ARG maxticket 100
...
```
PS C:\Users\huaxi\Desktop\cs5600-computer-system> python .\lottery.py -j 3 -s 3 -c
ARG jlist 
ARG jobs 3
ARG maxlen 10
ARG maxticket 100
